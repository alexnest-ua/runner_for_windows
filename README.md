...
УВАГА!!! Скрипт при рестарті (кожні 20 хвилин) вбиває запущені скрипти саме з mhddos_proxy, тому якщо запускаєте цей скрипт на Windows-машині, то свої атаки mhddos_proxy запускайте лише через [docker](https://github.com/alexnest-ua/auto_mhddos_alexnest/tree/docker), а краще на іншій машині [напряму](https://t.me/ddos_separ/990)  
